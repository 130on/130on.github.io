...
function init() {
   ...
   //add event handler for the 3 puzzle buttons
   ...
   setupPuzzle();
   // Add en event listener for the mouseup 
   document.addEventListener("mouseup", endBackground);

   // Add an event listener to show the solution button
   document.getElementById("solve").addEventListener("click",
      function () {
         // Remove all the inline background color style from each cell
...
function setupPuzzle() {
   ...
   for (var i = 0; i < puzzleCells.length; i++) {
      ...
      //set the cell color in response to a mouse down event
   ...
   document.getElementById("peek").addEventListener("click",
      function () {
         ...
         setTimeout(
            function () {
               // change the pink cells to white and red cells back to grey
               for (var i = 0; i < puzzleCells.length; i++) {
                  if (puzzleCells[i].style.backgroundColor === "rgb(255, 211, 21)") {
